...
class LoaiSanPham extends Migration
{
    ...
    public function up()
    {
        Schema::create('loai_san_pham', function (Blueprint $table) {$table->engine = 'InnoDB';
        ...
        $table->string('loai_san_pham_ten_en', 250)->comment('Tên loại # Tên loại sản phẩm (tiếng anh)');
