...
class CreateChuDeSanPhamTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->boolean('chu_de_san_pham_id')->primary();
			$table->boolean('chu_de_id')->index('chu_de_san_pham_chu_de_id_foreign');
			$table->boolean('san_pham_id')->index('chu_de_san_pham_san_pham_id_foreign');
