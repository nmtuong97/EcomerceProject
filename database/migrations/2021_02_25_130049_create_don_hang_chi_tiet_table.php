...
class CreateDonHangChiTietTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->boolean('don_hang_chi_tiet_id')->primary();
			$table->boolean('don_hang_id')->index('don_hang_chi_tiet_don_hang_id_foreign');
			$table->boolean('san_pham_id')->index('don_hang_chi_tiet_san_pham_id_foreign');
			$table->boolean('mau_sac_id')->index('don_hang_chi_tiet_mau_sac_id_foreign');
			$table->boolean('kich_thuoc_id')->index('don_hang_chi_tiet_kich_thuoc_id_foreign');
