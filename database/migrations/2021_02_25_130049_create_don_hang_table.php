...
class CreateDonHangTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->boolean('don_hang_id')->primary();
			$table->string('don_hang_ma');
			$table->boolean('khach_hang_id')->index('don_hang_khach_hang_id_foreign')->comment('id bảng khách hàng');
			$table->boolean('don_vi_van_chuyen_id')->index('don_hang_don_vi_van_chuyen_id_foreign')->comment('id đơn vị vận chuyển');
