...
class CreateSanPhamTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->boolean('san_pham_id')->primary()->comment('id sản phẩm');
			...
			$table->boolean('san_pham_trang_thai')->comment('trạng thái sản phẩm: 1:khả dụng, 2: khóa');
			...
			$table->boolean('loai_san_pham_id')->index('san_pham_loai_san_pham_id_foreign')->comment('id loại sản phẩm');
			$table->boolean('nsx_id')->nullable();
		});
	}
