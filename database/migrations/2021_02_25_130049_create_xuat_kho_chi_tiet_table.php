...
class CreateXuatKhoChiTietTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->boolean('xuat_kho_chi_tiet_id')->primary();
			$table->boolean('xuat_kho_id')->index('xuat_kho_chi_tiet_xuat_kho_id_foreign');
			$table->boolean('san_pham_id')->index('xuat_kho_chi_tiet_san_pham_id_foreign');
